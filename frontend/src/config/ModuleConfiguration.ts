...
export const MODULES: ModuleDefinition[] = [
    // System Definition
    { id: 'stakeholder', label: 'Stakeholder', icon: Users, route: 'stakeholder', category: 'system', minPackage: 'advanced' },
    { id: 'product-breakdown-structure', label: 'Product Breakdown Structure', icon: FolderTree, route: 'product-breakdown-structure', category: 'system', minPackage: 'advanced' },
    { id: 'mbse-models', label: 'MBSE Models', icon: Boxes, route: 'mbse-models', category: 'system', minPackage: 'complete' },
    { id: 'functions', label: 'Functions', icon: Zap, route: 'functions', category: 'system', minPackage: 'complete' },
    { id: 'interface-management', label: 'Interface Management', icon: Network, route: 'interface-management', category: 'system', minPackage: 'complete' },
    ...
    { id: 'tasks', label: 'Tasks', icon: ClipboardList, route: 'tasks', category: 'development', minPackage: 'core' },
    { id: 'change-requests', label: 'Change Requests', icon: GitBranch, route: 'change-requests', category: 'development', minPackage: 'advanced' },
    ...
    { id: 'lifecycle-status', label: 'Lifecycle Status', icon: Activity, route: 'lifecycle-status', category: 'development', minPackage: 'advanced' },
    ...
    { id: 'risk-management', label: 'Risk Management', icon: AlertTriangle, route: 'risk-management', category: 'assurance', minPackage: 'advanced' },
    ...
    { id: 'audit', label: 'Audit Log', icon: History, route: 'audit', category: 'assurance', minPackage: 'complete' },
]
