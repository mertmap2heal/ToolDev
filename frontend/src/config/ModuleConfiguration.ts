...
export const MODULES: ModuleDefinition[] = [
    ...
    { id: 'functions', label: 'Functions', icon: Zap, route: 'functions', category: 'system' },
    ...
    { id: 'validation', label: 'Validation', icon: FlaskConical, route: 'validation', category: 'assurance' },
    ...
    { id: 'audit', label: 'Audit Log', icon: History, route: 'audit', category: 'assurance' },
]
