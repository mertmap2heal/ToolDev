...
/** Redirects /projects/:projectId/requirements ΓåÆ .../requirements/browse preserving query. */
...
/** Redirects legacy .../requirements/traceability-views ΓåÆ .../requirements/traceability */
