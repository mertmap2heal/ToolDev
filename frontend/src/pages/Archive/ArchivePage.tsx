...
import { Search, Archive, RotateCcw, Trash2, Clock, FileStack, History } from 'lucide-react'
...
const cardClass = 'bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden flex flex-col'
      ...
      <div className="flex-1 overflow-y-auto pr-6 pb-6 space-y-6">
        ...
        <div className={cardClass}>
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
                  <Trash2 size={24} className="text-gray-600 dark:text-gray-300" />
                </div>
                <div>
            ...
            <div className="flex items-center gap-1 border-b border-gray-200 dark:border-gray-700 mt-4 mb-4">
              <button
          ...
          <div className="flex-1 overflow-x-auto flex flex-col min-h-[200px]">
            {activeTab === 'requirements' ? (
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Deleted Date</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Reason</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Expires In</th>
                  ...
                  {isLoading ? (
                    ...
                    <tr>
                      <td colSpan={6} className="px-6 py-12 text-center">
                        ...
                        <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">Items in trash older than 7 days are automatically removed.</p>
                      </td>
                    </tr>
                  ) : (
                    filteredItems.map((req) => (
                      <tr key={req.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        <td className="px-6 py-4">
                          <div>
                            <span className="font-mono text-sm text-gray-500 dark:text-gray-400 mr-2">{req.requirementId || req.id.substring(0, 8)}</span>
                            <span className="font-medium text-gray-900 dark:text-white">{req.title}</span>
                          </div>
                          {req.description && (
                            <p className="text-sm text-gray-500 dark:text-gray-400 truncate max-w-md mt-1">{req.description.replace(/<[^>]*>/g, '')}</p>
                          )}
                        </td>
              ...
              <div className="text-center py-20">
                <p className="text-gray-500 dark:text-gray-400">Issues trash is coming soon.</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className={cardClass}>
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">Glossary & Abbreviations</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">Project terms and abbreviations</p>
              </div>
            </div>
          </div>
        ...
        {/* Placeholder: Record retention & audit */}
        <div className={cardClass}>
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
                <History size={24} className="text-gray-600 dark:text-gray-300" />
              </div>
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">Record retention & audit</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">Regulatory retention and audit trail (e.g. DO-178)</p>
              </div>
            </div>
          </div>
        ...
        {/* Placeholder: Archived baselines / revisions */}
        <div className={cardClass}>
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
                <FileStack size={24} className="text-gray-600 dark:text-gray-300" />
              </div>
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">Archived baselines & revisions</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">Browse and restore archived baselines</p>
              </div>
            </div>
          </div>
          <div className="p-8 text-center">
