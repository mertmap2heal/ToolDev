...
export default function StakeholderPage() {
  ...
  return (
    <div className="space-y-6">
      <ProjectNavigation />
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Stakeholders</h2>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
        <p className="text-gray-600 dark:text-gray-400">Stakeholder management will be implemented here</p>
      </div>
    </div>
  )
}
