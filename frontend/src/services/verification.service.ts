...
export const verificationService = {
  ...
  getTestPlans: (projectId: string) => apiClient.get(`/verification/test-plans/${projectId}`),
  getTestCases: (projectId: string) => apiClient.get(`/verification/test-cases/${projectId}`),
