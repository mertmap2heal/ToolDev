...
| Objective completion matrix | `<ObjectiveCompletionMatrix standard dalFilter />` | (PROPOSED) `frontend/src/components/common/ObjectiveCompletionMatrix.tsx` | **NX-7 in ROADMAP-phase3.md. Reused across 5 module dashboards.** |
