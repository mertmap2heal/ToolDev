...
**Status: Shipped — PENDING_COMMIT_HASH (Issue #474, NX-11).** Bundled with LF-3 as ROADMAP NX-11 "Lifecycle persistence".
...
**Status: Shipped — PENDING_COMMIT_HASH (Issue #474, NX-11).** Bundled with LF-2 as ROADMAP NX-11 "Lifecycle persistence".
