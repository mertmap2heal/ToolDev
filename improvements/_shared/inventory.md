...
| **Lifecycle / Transition** | `/lifecycle-status` | `lifecycle.routes.ts` (4), `transitionChecklist.routes.ts` (16) | `LifecyclePhase`, `LifecycleTransition`, `TransitionChecklist`, `ChecklistVersion` | |
