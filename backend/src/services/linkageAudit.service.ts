...
export type LinkageAuditAction =
  ...
  | 'REQUIREMENT_COMMENT_DELETED'
  | 'REQUIREMENT_COMPONENT_CHANGED'
  | 'ISSUE_UNLINKED'
  | 'LINK_CREATED'
  | 'LINK_UPDATED'
  | 'LINK_REMOVED'
  ...
  | 'TEST_PLAN_LINKED'
  | 'TEST_PLAN_UNLINKED'
  | 'REQUIREMENTS_IMPORT_STARTED'
  | 'REQUIREMENTS_IMPORT_COMPLETED'
  | 'REQUIREMENTS_IMPORT_FAILED'
  | 'REQUIREMENTS_EXPORT_STARTED'
  | 'REQUIREMENTS_EXPORT_COMPLETED'
  | 'REQUIREMENTS_EXPORT_FAILED'
